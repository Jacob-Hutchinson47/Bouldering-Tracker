...
class SessionViewModel : ViewModel() {
    ...
    private val _draftSession = MutableStateFlow(Session("", "", "", mutableListOf()))
    ...
    fun updateDraftDetails(location: String, date: String, duration: String) {
    ...
    fun saveDraftAsNewSession() {
        ...
        _draftSession.value = Session("", "", "", mutableListOf())
    }
    ...
    // Converts data data type to string
    public fun getReadableDateString(date :Date): String {
